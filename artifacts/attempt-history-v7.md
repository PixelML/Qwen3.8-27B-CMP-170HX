...
- v7 (49005067): onstart-cmd passed a host path; container had no such file.
  Destroyed, recreated.
- v7b (49005407): DRAFT passed as lued/Qwen3.8-27B-DFlash2-W4A16 (nonexistent
  repo). Destroyed, recreated.
- v7c (49005754): main model download used huggingface-cli (removed in
  hub 1.27); empty dir crashed vLLM. Fixed with 'hf download'.
- v7d (49006147): same DRAFT bug as v7b. Fixed by leaving DRAFT unset
  (launcher auto-discovers local drafter).
- v7e (49006974): healthy, benchmarked, captured, destroyed.
